...
// Retry Logic Helper
async function retryOperation(operation, retries = 1, delay = 2000) {
    try {
...
export const analyzeAndOptimize = async (apiKey, code, hardware, scope = 'snippet', mock = false) => {
    if (mock) {
    ...
    return retryOperation(async () => {
        try {
            ...
            while (true) {
                ...
                if (!text)
                    throw new GeminiError("Model failed to generate text response.", true);
